...
- ❌ TODO: Locate Songs page fragment and RecyclerView adapter implementation
- ❌ TODO: Identify current song item layout and click handling structure
- ❌ TODO: Remove pencil icon from song item layout
- ❌ TODO: Implement full item click listener for navigation to Edit Song screen
- ❌ TODO: Update SongsAdapter to handle entire item clicks instead of icon clicks
- ❌ TODO: Ensure proper click feedback and ripple effects for entire item
- ❌ TODO: Adjust layout spacing and constraints after icon removal
- ❌ TODO: Test navigation functionality with full item clicks
- ❌ TODO: Build verification successful - no compilation errors
...
- ❌ TODO: Locate Songs page song item layout and current association icon
- ❌ TODO: Identify the house icon currently used for song-venue association
- ❌ TODO: Find the link icon used in "Associate selected" button for reference
- ❌ TODO: Replace house icon with link icon in song item layout
- ❌ TODO: Ensure consistent icon sizing and styling with existing design
- ❌ TODO: Verify icon accessibility and proper content descriptions
- ❌ TODO: Test visual consistency across different screen densities
- ❌ TODO: Build verification successful - no compilation errors
...
- ❌ TODO: Locate Associate Venues with Song page layout and fragment implementation
- ❌ TODO: Identify the redundant second title bar with duplicate title and back button
- ❌ TODO: Remove the secondary AppBarLayout/MaterialToolbar from the fragment layout
- ❌ TODO: Update layout constraints to connect content directly to parent after title removal
- ❌ TODO: Remove any toolbar setup code from the fragment if it exists
- ❌ TODO: Ensure main navigation title remains functional and displays correctly
- ❌ TODO: Test layout build successfully - no breaking changes
- ❌ TODO: Verify navigation and back button functionality through main navigation
- ❌ TODO: Build verification successful - no compilation errors
...
- ❌ TODO: Locate Venues page fragment and RecyclerView adapter implementation
- ❌ TODO: Identify current venue item layout and click handling structure
- ❌ TODO: Remove pencil icon from venue item layout
- ❌ TODO: Implement full item click listener for navigation to Edit Venue screen
- ❌ TODO: Update VenuesAdapter to handle entire item clicks instead of icon clicks
- ❌ TODO: Ensure proper click feedback and ripple effects for entire item
- ❌ TODO: Adjust layout spacing and constraints after icon removal
- ❌ TODO: Test navigation functionality with full item clicks
- ❌ TODO: Build verification successful - no compilation errors
